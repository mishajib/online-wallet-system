...
Route::group(['namespace' => 'Backend\User', 'as' => 'user.', 'middleware' =>
    ...
    Route::get('notification/all', 'DashboardController@notifications')->name('notification.all');
});
//End User Routes
...
Route::group(['prefix' => 'admin', 'namespace' => 'Backend\Admin', 'as' => 'admin.', 'middleware' => ['auth:admin', 'adminauth', 'preventBackHistory', 'demomode']], function () {
    ...
    Route::get('interest/transaction/all', 'InterestController@transactions')->name('interest.transactions');
