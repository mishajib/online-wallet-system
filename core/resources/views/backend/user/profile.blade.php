                            ...
                            <form action="{{ route('user.profile.update') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                           ...
                                           value="{{ Auth::user()->profile->name ?? old('name') }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('address_1') is-invalid @enderror"
                                           id="address_1" aria-describedby="address_1" name="address_1" required
                                           placeholder="Enter adress one"
                                           value="{{ Auth::user()->profile->address_1 ?? old('address_1') }}">
                                </div>

                                <div class="form-group">
                                    <label for="address_2">Address Two</label>
                                    <input type="text" class="form-control @error('address_2') is-invalid @enderror"
                                           id="phone" aria-describedby="address_2" name="address_2"
                                           placeholder="Enter adress two (optional)"
                                           value="{{ Auth::user()->profile->address_2 ?? old('address_2') }}">
                                </div>

                                <div class="form-group">
                                    <label for="country">Country</label>
                                    <select class="form-control @error('country') is-invalid @enderror" data-flag="true"
                                            name="country" id="country select2" data-placeholder="Select Country">
                                        <option value=""></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('city') is-invalid @enderror"
                                           ...
                                           value="{{ Auth::user()->profile->city ?? old('city') }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('postcode') is-invalid @enderror"
                                           ...
                                           value="{{ Auth::user()->profile->postcode ?? old('postcode') }}">
                                </div>
                            ...
                            <form action="" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control dropify @error('image') is-invalid @enderror"
                                           id="image" aria-describedby="image" name="image" data-default-file="url_of_your_file" required>
                                </div>
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control @error('old_password') is-invalid @enderror"
                                           id="old_password" aria-describedby="old_password" name="old_password" required
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password_confirm" class="form-control @error('password_confirmation') is-invalid @enderror"
                                           id="password_confirm" aria-describedby="password_confirm" name="password_confirmation" required
