...
@section('bg-color', 'bg-info')
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card bg-dark shadow p-3 rounded text-white">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="username" type="text"
                                           class="form-control bg-dark text-white @error('username') is-invalid @enderror"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="postcode" type="text"
                                           class="form-control bg-dark text-white @error('postcode') is-invalid @enderror"
                            ...
                            @if($ref_user)
                                <div class="form-group row">
                                    <label for="refer"
                                           class="col-md-4 col-form-label text-md-right">{{ __('Refer Username') }}</label>

                                    <div class="col-md-6">
                                        <input id="refer" type="text"
                                               class="form-control bg-dark text-white @error('refer') is-invalid @enderror"
                                               name="refer" value="{{ old('refer') ?? $ref_user->username }}" autocomplete="refer">
